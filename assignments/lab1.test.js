...
console.log(lab1.questionThree("Hello Everyone")); // Returns and then outputs 7 
console.log(lab1.questionThree("Web development is fun!"));  // Returns and then outputs 12 
...
console.log(lab1.questionFour("Helll llllo, class!", "lll")); // Returns and then outputs 2
console.log(lab1.questionFour("web development, I like it!", "e")); // Returns and then outputs 5
console.log(lab1.questionFour("Hey, I will get good grades!", "ll"));// Returns and then outputs 1
